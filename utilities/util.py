...
class Util(object):
    ...
    def verifyTextContains(self, actualText, expectedText):
        ...
        if expectedText.lower() in actualText.lower():
            self.log.info("--- PASS - Expected Text MATCHES the Actual Text!")
            return True
        else:
            self.log.info("--- FAIL - Expected Text DOES NOT MATCH the Actual Text!")
            return False
    ...
    def verifyTextMatch(self, actualText, expectedText):
        ...
        if actualText.lower() == expectedText.lower():
            self.log.info("--- Expected Text is EQUAL to Actual Text!")
            return True
        else:
            self.log.info("--- Expected Text is NOT EQUAL to Actual Text!")
            return False
